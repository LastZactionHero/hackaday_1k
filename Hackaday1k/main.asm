...
;.db "I am a string that uses word wrapping to extend to multiple lines.", 0x00, 0x00
...
; Insert line breaks before words that will carry on to another line.
add_line_breaks:
	ldi ZH, 0x03 ; start of message buffer
	ldi ZL, 0x40

	ldi r17, 0x02 ; current x position
